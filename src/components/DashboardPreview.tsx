    ...
    <section className="py-16 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-12 text-center">
        <h2 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
          Tu panel de control de carrera
        </h2>
        <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
          Todo lo que necesitas para dominar el mercado laboral en una sola
          pantalla, diseñado para ser intuitivo y agradable.
        </p>
      </div>
        ...
        <div className="group relative md:col-span-4 md:row-span-2 overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="p-8 relative z-10 h-full flex flex-col">
            ...
            <p className="mt-2 max-w-sm text-slate-500">
              Arrastra y suelta tus postulaciones desde "Aplicado" hasta "Oferta
              Aceptada".
            </p>
